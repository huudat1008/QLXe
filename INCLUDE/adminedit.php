<?php
    ...
    <div class="admin-header-row">
        <div class="admin-header-left">
            ...
            <a href="../index" class="admin-header-left-title">Administrator</a>
        </div>
        <div class="admin-header-center">
            <a href="../../index" class="admin-header-center-link">Về trang web</a>
            <a href="../order" class="admin-header-center-link">Đơn hàng</a>
            <a href="../display" class="admin-header-center-link">Giao diện</a>
            <a href="../product" class="admin-header-center-link">Sản phẩm</a>
            <a href="../customer" class="admin-header-center-link">Khách hàng</a>';
    $adheader1 = '</div>
    ...
    $adheader2 = '</span>
            ...
            <div class="user">
                <div class="user-group">
                    <div class="user-link"><a href="../users-action/edit" class="user-edit">Đổi mật khẩu</a></div>
                    <div class="user-link">
